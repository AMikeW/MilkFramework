...
namespace StarForce
{
    public static class UIExtension
    {
        ...
        public static int? OpenUIForm(this UIComponent uiComponent, int uiFormId, object userData = null)
        {
            ...
            return uiComponent.OpenUIForm(assetName, drUIForm.UIGroupName, Constant.AssetPriority.UIFormAsset, drUIForm.PauseCoveredUIForm, drUIForm.LuaRelativePath, userData);
        }
